...
public class Callcontb {

    public int return_code = 0;
    public com.systema.modernized.runtime.CobolNumeric ws_original = new com.systema.modernized.runtime.CobolNumeric(new BigDecimal("123.45"), new com.systema.modernized.runtime.CobolNumericSpec(true, 7, 2, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    ...
    private void main_process() {
        ...
        if (!skipToNextSentence) {
            Mutatorb mutatorb_1 = new Mutatorb(this);
                    java.math.BigDecimal _snap_ws_original__1 = ws_original;
                    mutatorb_1.ls_param = _snap_ws_original__1;
                    mutatorb_1.execute();
                    return_code = mutatorb_1.return_code;
        }
        if (!skipToNextSentence) {
            {
                    writeBytes(new com.systema.modernized.runtime.CobolNumeric(ws_original.getValue(), new com.systema.modernized.runtime.CobolNumericSpec(true, 7, 2, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).toDisplayString().getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
                    System.out.write(10);
                    System.out.flush();
                }
        }
    ...
    public static class Mutatorb {
        private final Callcontb parent;
        public Mutatorb(Callcontb parent) {
            this.parent = parent;
        }
    
        public int return_code = 0;
        public com.systema.modernized.runtime.CobolNumeric ls_param = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(true, 7, 2, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
        {  // Initialise redefines values
        }
        ...
        private void main_process() {
            skipToNextSentence = false;
            if (!skipToNextSentence) { ls_param.assign(com.systema.modernized.runtime.CobolArithmetic.add(ls_param.getValue(), new BigDecimal("1.00")), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED); }
            skipToNextSentence = false;
            if (!skipToNextSentence) { if (true) { programExited = true; return; } }
        }
