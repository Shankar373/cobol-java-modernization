...
public class Hiscale {

    public int return_code = 0;
    public String ws_group = "";
    public com.systema.modernized.runtime.CobolNumeric a = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(false, 22, 20, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    ...
    private void populate_ws_group(String line) {
        ...
        ws_group = line;
        if (line.length() >= 22) {
            String val = line.substring(0, 22).trim();
            a.assign(val.isEmpty() ? BigDecimal.ZERO : new BigDecimal(val).movePointLeft(20));
        }
    }
    ...
    private void main_process() {
        ...
        if (!skipToNextSentence) { a.assign(BigDecimal.ZERO, com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED); }
        skipToNextSentence = false;
        if (!skipToNextSentence) { a.assign(new BigDecimal("0"), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED); }
        skipToNextSentence = false;
        {
            com.systema.modernized.runtime.CobolArithmetic.checkPrecision(22, 20);
            if (!((new BigDecimal("3")).compareTo(BigDecimal.ZERO) == 0)) {
                a.assign(com.systema.modernized.runtime.CobolArithmetic.divide(new BigDecimal("1"), new BigDecimal("3")), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED);
            }
        }
        skipToNextSentence = false;
        {
