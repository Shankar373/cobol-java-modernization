...
public class Comp3rt {

    public int return_code = 0;
    public String ws_group = "";
    public com.systema.modernized.runtime.CobolNumeric a = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(true, 6, 2, com.systema.modernized.runtime.CobolUsage.COMP_3, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    public String filler_1 = "|";
    public com.systema.modernized.runtime.CobolNumeric b = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(false, 6, 2, com.systema.modernized.runtime.CobolUsage.COMP_3, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    ...
    private void main_process() {
        ...
        skipToNextSentence = false;
        if (!skipToNextSentence) { b.assign(new BigDecimal("12.34"), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED); }
        skipToNextSentence = false;
        {
