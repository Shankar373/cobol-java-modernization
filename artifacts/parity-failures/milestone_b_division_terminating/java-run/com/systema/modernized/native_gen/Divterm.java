...
public class Divterm {
    ...
    public com.systema.modernized.runtime.CobolNumeric c1 = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(false, 2, 2, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    public String filler_1 = "|";
    public com.systema.modernized.runtime.CobolNumeric c2 = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(false, 11, 9, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    ...
    private void populate_ws_group(String line) {
        ...
        if (line.length() >= 2) {
            ...
            c1.assign(val.isEmpty() ? BigDecimal.ZERO : new BigDecimal(val).movePointLeft(2));
        }
        if (line.length() >= 3) {
            String val = line.substring(2, 3).trim();
            filler_1 = val;
        }
        if (line.length() >= 14) {
            String val = line.substring(3, 14).trim();
            c2.assign(val.isEmpty() ? BigDecimal.ZERO : new BigDecimal(val).movePointLeft(9));
        }
    }
    ...
    private void main_process() {
        ...
        if (!skipToNextSentence) {
            c1.assign(BigDecimal.ZERO, com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED);
                    c2.assign(BigDecimal.ZERO, com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED);
        }
        skipToNextSentence = false;
        if (!skipToNextSentence) { c1.assign(new BigDecimal("0"), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED); }
        skipToNextSentence = false;
        if (!skipToNextSentence) { c2.assign(new BigDecimal("0"), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED); }
        skipToNextSentence = false;
        {
            com.systema.modernized.runtime.CobolArithmetic.checkPrecision(2, 2);
            if (!((new BigDecimal("3")).compareTo(BigDecimal.ZERO) == 0)) {
                c1.assign(com.systema.modernized.runtime.CobolArithmetic.divide(new BigDecimal("1"), new BigDecimal("3")), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED);
            }
        }
        skipToNextSentence = false;
        {
            com.systema.modernized.runtime.CobolArithmetic.checkPrecision(11, 9);
            if (!((new BigDecimal("3")).compareTo(BigDecimal.ZERO) == 0)) {
                c2.assign(com.systema.modernized.runtime.CobolArithmetic.divide(new BigDecimal("10"), new BigDecimal("3")), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED);
            }
        }
        skipToNextSentence = false;
        {
