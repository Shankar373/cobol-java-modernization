...
public class Redefsc {
    ...
    public Integer get_b() {
        int off = 0;
        return (int) new com.systema.modernized.runtime.CobolNumeric(ws_group_backing, off, 4, new com.systema.modernized.runtime.CobolNumericSpec(false, 4, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).getValue().intValue();
    }

    public void set_b(Integer val) {
        int off = 0;
        new com.systema.modernized.runtime.CobolNumeric(ws_group_backing, off, 4, new com.systema.modernized.runtime.CobolNumericSpec(false, 4, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).assign(java.math.BigDecimal.valueOf(val));
    }
    ...
    private void main_process() {
        ...
        if (!skipToNextSentence) { set_a(padString(String.valueOf(""), 4)); }
        skipToNextSentence = false;
        if (!skipToNextSentence) { set_a(padString(String.valueOf("1234"), 4)); }
        skipToNextSentence = false;
        {
        ...
        skipToNextSentence = false;
        if (!skipToNextSentence) { set_b(5678); }
        skipToNextSentence = false;
        {
        writeBytes(get_ws_group_bytes());
        System.out.write(10);
