...
public class Twodisp {
    ...
    private void main_process() {
        ...
        skipToNextSentence = false;
        if (!skipToNextSentence) { a = 1234; }
        skipToNextSentence = false;
        if (!skipToNextSentence) { b = 5678; }
        skipToNextSentence = false;
        {
        writeBytes(new com.systema.modernized.runtime.CobolNumeric(java.math.BigDecimal.valueOf(a), new com.systema.modernized.runtime.CobolNumericSpec(false, 4, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).toDisplayString().getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
        writeBytes(" ".getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
        writeBytes(new com.systema.modernized.runtime.CobolNumeric(java.math.BigDecimal.valueOf(b), new com.systema.modernized.runtime.CobolNumericSpec(false, 4, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).toDisplayString().getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
        System.out.write(10);
        System.out.flush();
    }
        skipToNextSentence = false;
