...
public class Signedar {
    ...
    public byte[] get_ws_group_bytes() {
        byte[] c_0 = formatSigned(a, 4, true).getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
        byte[] c_1 = filler_1.getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
        byte[] c_2 = formatSigned(b, 4, true).getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
        byte[] c_3 = filler_2.getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
        byte[] c_4 = formatSigned(c, 4, true).getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
