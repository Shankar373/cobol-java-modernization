...
public class Multircv {
    ...
    public com.systema.modernized.runtime.CobolNumeric b = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(false, 5, 1, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    public String filler_2 = "|";
    public com.systema.modernized.runtime.CobolNumeric c = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(false, 6, 2, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    ...
    private void populate_ws_group(String line) {
        ...
        if (line.length() >= 12) {
            String val = line.substring(7, 12).trim();
            b.assign(val.isEmpty() ? BigDecimal.ZERO : new BigDecimal(val).movePointLeft(1));
        }
        if (line.length() >= 13) {
            String val = line.substring(12, 13).trim();
            filler_2 = val;
        }
        if (line.length() >= 19) {
            String val = line.substring(13, 19).trim();
            c.assign(val.isEmpty() ? BigDecimal.ZERO : new BigDecimal(val).movePointLeft(2));
        }
    }
    ...
    private void main_process() {
        ...
        skipToNextSentence = false;
        if (!skipToNextSentence) {
            b.assign(com.systema.modernized.runtime.CobolArithmetic.add(b.getValue(), a.getValue()), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED);
                    c.assign(com.systema.modernized.runtime.CobolArithmetic.add(c.getValue(), a.getValue()), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED);
        }
        skipToNextSentence = false;
        {
