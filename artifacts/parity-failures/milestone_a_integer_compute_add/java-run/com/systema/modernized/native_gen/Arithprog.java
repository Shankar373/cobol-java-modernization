...
public class Arithprog {
    ...
    public int ws_num_a = 10;
    public int ws_num_b = 20;
    public int ws_num_c = 0;
    ...
    private void main_process() {
        ...
        if (!skipToNextSentence) { ws_num_c = (int)((ws_num_a + ws_num_b) % 10000L); }
        {
        writeBytes(new com.systema.modernized.runtime.CobolNumeric(java.math.BigDecimal.valueOf(ws_num_c), new com.systema.modernized.runtime.CobolNumericSpec(false, 4, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).toDisplayString().getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
        System.out.write(10);
        System.out.flush();
    }
        if (!skipToNextSentence) { ws_num_c = (int)((com.systema.modernized.runtime.CobolArithmetic.add(com.systema.modernized.runtime.CobolArithmetic.multiply(BigDecimal.valueOf(ws_num_a), new BigDecimal("5")), BigDecimal.valueOf(ws_num_b))).longValue() % 10000L); }
        {
        writeBytes(new com.systema.modernized.runtime.CobolNumeric(java.math.BigDecimal.valueOf(ws_num_c), new com.systema.modernized.runtime.CobolNumericSpec(false, 4, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).toDisplayString().getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
        System.out.write(10);
        System.out.flush();
