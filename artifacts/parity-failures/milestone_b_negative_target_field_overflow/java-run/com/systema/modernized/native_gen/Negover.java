...
public class Negover {
    ...
    public byte[] get_ws_group_bytes() {
        byte[] c_0 = formatSigned(a, 2, true).getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
        byte[] c_1 = filler_1.getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
        byte[] c_2 = formatSigned(b, 2, true).getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
    ...
    private void main_process() {
        ...
        skipToNextSentence = false;
        {
        if (checkSizeError((a - 5), 2, true)) {
            {
        writeBytes("UNDERFLOW".getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
        System.out.write(10);
        System.out.flush();
    }
        } else {
