...
public class Pvary {
    ...
    private final int total_paras = 2;
    ...
    private void main_process() {
        ...
        if (!skipToNextSentence) {
            {
                    writeBytes(new com.systema.modernized.runtime.CobolNumeric(java.math.BigDecimal.valueOf(ws_sum), new com.systema.modernized.runtime.CobolNumericSpec(false, 6, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).toDisplayString().getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
                    System.out.write(10);
                    System.out.flush();
                }
        }
    ...
    private void add_loop() {
        skipToNextSentence = false;
        if (!skipToNextSentence) { ws_sum = (int)((ws_sum + ws_i) % 1000000L); }
    }
