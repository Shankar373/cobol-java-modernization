...
public class Moveprog {

    public int return_code = 0;
    public String ws_str_a = "ABC       ";
    public String ws_str_b = "     ";
    public int ws_num_a = 123;
    public int ws_num_b = 0;
    ...
    private void main_process() {
        ...
        if (!skipToNextSentence) { ws_str_b = padString(String.valueOf(ws_str_a), 5); }
        if (!skipToNextSentence) { ws_num_b = ws_num_a; }
        {
        writeBytes(ws_str_b.getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
        System.out.write(10);
        System.out.flush();
    }
        {
        writeBytes(new com.systema.modernized.runtime.CobolNumeric(java.math.BigDecimal.valueOf(ws_num_b), new com.systema.modernized.runtime.CobolNumericSpec(false, 6, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).toDisplayString().getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
        System.out.write(10);
        System.out.flush();
    }
