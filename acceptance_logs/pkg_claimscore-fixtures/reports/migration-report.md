...
- **repo**: `C:\Users\bandi\Desktop\SystemaOps\Cobol-to-java-test\workspace\claimscore-fixtures-7\repo`
- **target project**: `C:\Users\bandi\Desktop\SystemaOps\Cobol-to-java-test\workspace\claimscore-fixtures-7\target`
- **run at**: 2026-08-26T01:20:03+00:00 (UTC)
...
- **DB2 dialect verification**: `NOT_VERIFIED`
- **REAL_DB2_EXECUTION**: `NOT_APPLICABLE` (No SQL queries parsed)

## Mainframe Semantics Verification

- **JCL parsing & execution**: `NOT_VERIFIED` (Mainframe JCL tasklets emulated via JclExecutionContext)
- **CICS / BMS terminal screens**: `CICS_NOT_VERIFIED`
- **VSAM / ISAM storage**: `EMULATED` (Local SQLite indexed storage engine)
