...
| **Dynamic Occurs** | `OCCURS DEPENDING ON` | GnuCOBOL / z390 | ONLY TESTED SCOPE | PARTIAL | NO | YES | NO | Standard Java / JVM | **PARTIALLY_PROVEN** | Medium |
...
| **Out-of-Line Perform** | `PERFORM PARA-A THRU PARA-B` | GnuCOBOL | ONLY TESTED SCOPE | PARTIAL | NO | NO | NO | Standard Java / JVM | **PARTIALLY_PROVEN** | High |
| **Unconditional Branch**| `GO TO` | GnuCOBOL | ONLY TESTED SCOPE | PARTIAL | NO | NO | NO | Standard Java / JVM | **PARTIALLY_PROVEN** | High |
...
| **Dynamic Subprogram** | `CALL identifier` | GnuCOBOL | ONLY TESTED SCOPE | PARTIAL | NO | YES | NO | Standard Java / JVM | **PARTIALLY_PROVEN** | Medium |
| **String Concatenation**| `STRING ... DELIMITED BY` | GnuCOBOL / z390 | YES | YES | YES | NO | NO | Standard Java / JVM | **PROVEN** | Low |
| **String Splitting** | `UNSTRING ... DELIMITED BY` | GnuCOBOL | ONLY TESTED SCOPE | PARTIAL | NO | YES | NO | Standard Java / JVM | **PARTIALLY_PROVEN** | Medium |
| **String Inspection** | `INSPECT REPLACING / TALLYING` | GnuCOBOL | ONLY TESTED SCOPE | PARTIAL | NO | YES | NO | Standard Java / JVM | **PARTIALLY_PROVEN** | Medium |
...
| **Record Sequential Files**| `ORGANIZATION RECORD SEQUENTIAL` | GnuCOBOL / z390 | ONLY TESTED SCOPE | PARTIAL | NO | NO | NO | Standard Java / JVM | **PARTIALLY_PROVEN** | Medium |
| **VSAM KSDS** | `ORGANIZATION INDEXED` | zVSAM (z390) | ONLY EMULATION | ONLY RELATIONAL | NO | YES | NO | Relational DB (PostgreSQL/H2) | **SIMULATED** | High |
| **VSAM RRDS** | `ORGANIZATION RELATIVE` | zVSAM (z390) | NO | NO | NO | YES | YES | Relational DB | **UNPROVEN** | High |
...
| **EBCDIC Encoding** | EBCDIC Collation / Charset | ICU4J / z390 | YES (ICU4J) | PARTIAL | NO | NO | NO | `CobolCharsetAdapter` | **UNSUPPORTED** | High |
