...
public class Neghalf {

    public int return_code = 0;
    public String ws_group = "";
    public com.systema.modernized.runtime.CobolNumeric a = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(true, 6, 2, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    public String filler_1 = "|";
    public com.systema.modernized.runtime.CobolNumeric b = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(true, 6, 2, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    ...
    private void main_process() {
        ...
        skipToNextSentence = false;
        if (!skipToNextSentence) { a.assign(new BigDecimal("-1.235"), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED); }
        skipToNextSentence = false;
        ...
        skipToNextSentence = false;
        if (!skipToNextSentence) { b.assign(a.getValue(), com.systema.modernized.runtime.CobolRoundingMode.NEAREST_AWAY_FROM_ZERO, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED); }
        skipToNextSentence = false;
        {
