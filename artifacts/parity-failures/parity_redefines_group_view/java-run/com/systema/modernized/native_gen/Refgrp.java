...
public class Refgrp {
    ...
    private final byte[] ws_group_a_backing = new byte[4];
    {
        java.util.Arrays.fill(ws_group_a_backing, (byte) 32);
    }

    // --- REDEFINES Accessors ---
    public String get_ws_group_a() {
        int off = 0;
        return new String(ws_group_a_backing, off, 4, java.nio.charset.StandardCharsets.ISO_8859_1);
    }

    public void set_ws_group_a(String val) {
        int off = 0;
        if (val == null) val = "";
        String padded = padString(val, 4);
        byte[] src = padded.getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
        System.arraycopy(src, 0, ws_group_a_backing, off, 4);
    }

    public Integer get_ga_high() {
        int off = 0;
        return (int) new com.systema.modernized.runtime.CobolNumeric(ws_group_a_backing, off, 2, new com.systema.modernized.runtime.CobolNumericSpec(false, 2, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).getValue().intValue();
    }

    public void set_ga_high(Integer val) {
        int off = 0;
        new com.systema.modernized.runtime.CobolNumeric(ws_group_a_backing, off, 2, new com.systema.modernized.runtime.CobolNumericSpec(false, 2, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).assign(java.math.BigDecimal.valueOf(val));
    }

    public Integer get_ga_low() {
        int off = 2;
        return (int) new com.systema.modernized.runtime.CobolNumeric(ws_group_a_backing, off, 2, new com.systema.modernized.runtime.CobolNumericSpec(false, 2, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).getValue().intValue();
    }

    public void set_ga_low(Integer val) {
        int off = 2;
        new com.systema.modernized.runtime.CobolNumeric(ws_group_a_backing, off, 2, new com.systema.modernized.runtime.CobolNumericSpec(false, 2, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).assign(java.math.BigDecimal.valueOf(val));
    }

    public String get_ws_group_b() {
        int off = 0;
        return new String(ws_group_a_backing, off, 4, java.nio.charset.StandardCharsets.ISO_8859_1);
    }

    public void set_ws_group_b(String val) {
        int off = 0;
        if (val == null) val = "";
        String padded = padString(val, 4);
        byte[] src = padded.getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
    ...
    public Integer get_gb_full() {
        int off = 0;
        return (int) new com.systema.modernized.runtime.CobolNumeric(ws_group_a_backing, off, 4, new com.systema.modernized.runtime.CobolNumericSpec(false, 4, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).getValue().intValue();
    }

    public void set_gb_full(Integer val) {
        int off = 0;
        new com.systema.modernized.runtime.CobolNumeric(ws_group_a_backing, off, 4, new com.systema.modernized.runtime.CobolNumericSpec(false, 4, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).assign(java.math.BigDecimal.valueOf(val));
    }
    ...
    public byte[] get_ws_group_a_bytes() {
        return ws_group_a_backing;
    }
    public byte[] get_ws_group_b_bytes() {
        byte[] c_0 = formatSigned(gb_full, 4, false).getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
        byte[] res = new byte[c_0.length];
        System.arraycopy(c_0, 0, res, 0, c_0.length);
        return res;
    }
    private void populate_ws_group_a(String line) {
        if (line == null) line = "";
        byte[] src = line.getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
        System.arraycopy(src, 0, ws_group_a_backing, 0, Math.min(src.length, 4));
    }
    private void populate_ws_group_b(String line) {
        if (line == null) line = "";
        set_ws_group_b(line);
        if (line.length() >= 4) {
            String val = line.substring(0, 4).trim();
            set_gb_full(val.isEmpty() ? 0 : Integer.parseInt(val));
        }
    }
    ...
    private void main_process() {
        ...
        if (!skipToNextSentence) { set_ga_high(12); }
        skipToNextSentence = false;
        if (!skipToNextSentence) { set_ga_low(34); }
        skipToNextSentence = false;
        if (!skipToNextSentence) {
            {
                    writeBytes(new com.systema.modernized.runtime.CobolNumeric(java.math.BigDecimal.valueOf(get_gb_full()), new com.systema.modernized.runtime.CobolNumericSpec(false, 4, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).toDisplayString().getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
                    System.out.write(10);
                    System.out.flush();
                }
        }
        skipToNextSentence = false;
        if (!skipToNextSentence) { set_gb_full(5678); }
        skipToNextSentence = false;
        if (!skipToNextSentence) {
            {
                    writeBytes(new com.systema.modernized.runtime.CobolNumeric(java.math.BigDecimal.valueOf(get_ga_high()), new com.systema.modernized.runtime.CobolNumericSpec(false, 2, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).toDisplayString().getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
                    System.out.write(10);
                    System.out.flush();
                }
        }
        ...
        if (!skipToNextSentence) {
            {
                    writeBytes(new com.systema.modernized.runtime.CobolNumeric(java.math.BigDecimal.valueOf(get_ga_low()), new com.systema.modernized.runtime.CobolNumericSpec(false, 2, 0, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false)).toDisplayString().getBytes(java.nio.charset.StandardCharsets.ISO_8859_1));
                    System.out.write(10);
                    System.out.flush();
                }
        }
