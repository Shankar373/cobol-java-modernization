...
public class SUBPROG1 implements CobolRunnable {
  ...
  public int run(CobolDataStorage... argStorages) {
    return SUBPROG1_(0, argStorages);
  }
  ...
  public int SUBPROG1_ (int entry, CobolDataStorage ...argStorages) {
    this.entry = entry;
  ...
  int run_module (int entry) {
    ...
    CobolResolve.pushCallStackList ("SUBPROG1");

    /* Initialize program */
    if (!this.initialized) {
      module.setProgramId("SUBPROG1");
  ...
  public CobolControl[] contList = {
    new CobolControl(0, CobolControl.LabelType.label) {
      public Optional<CobolControl> run() throws CobolRuntimeException, CobolStopRunException {
        ...
        return Optional.of(contList[l_SUBPROG1]);
      }
    },
    /* Entry SUBPROG1 */
    new CobolControl(l_SUBPROG1, CobolControl.LabelType.label) {
      public Optional<CobolControl> run() throws CobolRuntimeException, CobolStopRunException {
    ...
    new CobolControl(l_MAIN_SECTION__DEFAULT_PARAGRAPH, CobolControl.LabelType.label) {
      public Optional<CobolControl> run() throws CobolRuntimeException, CobolStopRunException {
        ...
        /* SUBPROG1.cob:10: MOVE */
        {
          b_CHN_RECORD.getSubDataStorage(8).setBytes (str_0_ADDITION, 20);
        }
        /* SUBPROG1.cob:11: GOBACK */
        {
  ...
  /* String literals */
  public static final byte[] str_0_ADDITION = CobolUtil.stringToBytes("ADDITION DONE       ");

  /* Sections and Labels */
  private final static int l_SUBPROG1 = 1;
