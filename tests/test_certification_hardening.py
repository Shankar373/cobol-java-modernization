...
from modernize.capability_matrix import classify_feature, get_unsupported_features, CapabilityStatus
...
def test_capability_matrix():
    ...
    assert classify_feature("EXEC_SQL") == CapabilityStatus.PARTIAL
