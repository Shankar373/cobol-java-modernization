...
public class Compmix {

    public int return_code = 0;
    public String ws_group = "";
    public com.systema.modernized.runtime.CobolNumeric a = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(false, 6, 2, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    public String filler_1 = "|";
    public com.systema.modernized.runtime.CobolNumeric b = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(false, 7, 3, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    public String filler_2 = "|";
    public com.systema.modernized.runtime.CobolNumeric c = new com.systema.modernized.runtime.CobolNumeric(new com.systema.modernized.runtime.CobolNumericSpec(false, 5, 1, com.systema.modernized.runtime.CobolUsage.DISPLAY, com.systema.modernized.runtime.CobolSignPosition.TRAILING, false));
    ...
    public byte[] get_ws_group_bytes() {
        ...
        byte[] c_3 = filler_2.getBytes(java.nio.charset.StandardCharsets.ISO_8859_1);
        byte[] c_4 = c.toStorageImage();
        byte[] res = new byte[c_0.length + c_1.length + c_2.length + c_3.length + c_4.length];
        ...
        System.arraycopy(c_3, 0, res, 0 + c_0.length + c_1.length + c_2.length, c_3.length);
        System.arraycopy(c_4, 0, res, 0 + c_0.length + c_1.length + c_2.length + c_3.length, c_4.length);
        return res;
    }
    private void populate_ws_group(String line) {
        ...
        if (line.length() >= 6) {
            ...
            a.assign(val.isEmpty() ? BigDecimal.ZERO : new BigDecimal(val).movePointLeft(2));
        }
        if (line.length() >= 7) {
            String val = line.substring(6, 7).trim();
            filler_1 = val;
        }
        if (line.length() >= 14) {
            String val = line.substring(7, 14).trim();
            b.assign(val.isEmpty() ? BigDecimal.ZERO : new BigDecimal(val).movePointLeft(3));
        }
        if (line.length() >= 15) {
            String val = line.substring(14, 15).trim();
            filler_2 = val;
        }
        if (line.length() >= 20) {
            String val = line.substring(15, 20).trim();
            c.assign(val.isEmpty() ? BigDecimal.ZERO : new BigDecimal(val).movePointLeft(1));
        }
    }
    ...
    private void main_process() {
        ...
        if (!skipToNextSentence) {
            a.assign(BigDecimal.ZERO, com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED);
                    ...
                    c.assign(BigDecimal.ZERO, com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED);
        }
        skipToNextSentence = false;
        if (!skipToNextSentence) { a.assign(new BigDecimal("12.34"), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED); }
        skipToNextSentence = false;
        if (!skipToNextSentence) { b.assign(new BigDecimal("5.678"), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED); }
        skipToNextSentence = false;
        if (!skipToNextSentence) { c.assign(new BigDecimal("0"), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED); }
        skipToNextSentence = false;
        if (!skipToNextSentence) { c.assign(com.systema.modernized.runtime.CobolArithmetic.add(com.systema.modernized.runtime.CobolArithmetic.multiply(a.getValue(), b.getValue()), new BigDecimal("1.2")), com.systema.modernized.runtime.CobolRoundingMode.TRUNCATION, com.systema.modernized.runtime.SizeErrorPolicy.UNCHECKED); }
        skipToNextSentence = false;
        {
